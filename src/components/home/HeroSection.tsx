      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        >
          <motion.p
            ...
            className="text-lg md:text-xl font-medium tracking-widest uppercase mb-4"
          ...
          >
            ...
            <span className="block" style={{ 
              background: 'linear-gradient(135deg, hsl(45 95% 70%), hsl(20 90% 60%))',
          ...
          >
            ...
            Each piece tells a story of heritage, tradition, and artistry.
          </motion.p>
          ...
          >
            <Link to="/products">
              <Button size="lg" className="btn-sunset text-lg px-8 py-6 group">
                Shop Now
